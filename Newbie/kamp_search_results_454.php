      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li><a href="index.php/#about.php">About</a></li>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="pages/kamp_login.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>          </ul>
        </div>
      </div>
    </nav>
  <br></br></br></br>
                            ...
                            while ($rows=mysqli_fetch_array($result)) {
                              ...
                              <div class='col-sm-4'>
                                <div class='panel panel-primary'>
                                  ...
                                  color: #f2f2f2 ;'href='pages/kamp_login.php'>
                                   $pro_title </a></div>
